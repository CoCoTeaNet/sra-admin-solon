...
public class FileUploadUtils {
     ...
     */
    public static FileInfo saveMultipartFile(UploadedFile uploadedFile, String targetUrl) {
        // 文件流
        ...
        try {
            inputStream = uploadedFile.getContent();
            // 1K的数据缓冲
     ...
     * @return File
     */
    public static File multipartFileToFile(UploadedFile uploadedFile) {
        File file = null;
        try {
            String originalFilename = uploadedFile.getName();
