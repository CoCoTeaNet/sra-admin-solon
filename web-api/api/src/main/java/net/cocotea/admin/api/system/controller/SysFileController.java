...
public class SysFileController {
    ...
    public ApiResult<String> upload(@Param("file") UploadedFile uploadedFile,
        ...
        if (isSave != null && isSave == 1) {
            SysFileAddDTO param = new SysFileAddDTO()
    ...
    @Post
    @Mapping("/update")
    public ApiResult<?> update(@Body SysFileUpdateDTO param) throws BusinessException {
    ...
    @Post
    @Mapping("/listByPage")
    public ApiResult<?> listByPage(@Body SysFilePageDTO param) throws BusinessException {
    ...
    public ApiResult<?> recycleBinPage(@Body SysFilePageDTO param) throws BusinessException {
