 ...
 * @author jwss
 */
public interface SysMenuService extends IBaseService<Page<SysMenuVO>, SysMenuPageDTO, SysMenuAddDTO, SysMenuUpdateDTO> {
    /**
     * 分页查询菜单
     * @param pageParam 分页参数
     * @return 分页结果集
     */
    Collection<SysMenuVO> listByTree(SysMenuPageDTO param);
    ...
    Collection<SysMenuVO> listByTreeAsRoleSelection(SysMenuPageDTO pageParam);
}
